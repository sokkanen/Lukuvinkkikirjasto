Feature: A new book can be created if proper info is given
    ...
    Scenario: creation is successful with valid title, author and ISBN
        ...
        When  title is "test book", author is "C. reation", ISBN is "978-952-5802-04-5"
        Then  system will respond with book info: title "test book", author "C. reation" and ISBN "978-952-5802-04-5"
    ...
    Scenario: creation is successful with empty author
        Given command new is selected
        When  title is "Best book 4ever", author is empty, ISBN is "978-952-5802-04-2"
        Then  system will respond with "Best book 4ever"
        And   system will respond with "978-952-5802-04-2"
